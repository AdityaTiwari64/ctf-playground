...
const sampleChallenges = [
  ...
  },
  {
    ...
    difficulty: "easy",
    challengeLink: "https://cryptii.com/pipes/caesar-cipher",
  ...
  },
  {
    ...
    difficulty: "medium",
    challengeLink: "https://pwn.college/fundamentals/buffer-overflow",
  ...
  },
  {
    ...
    difficulty: "medium",
    challengeLink: "https://osintframework.com/",
...
export async function POST(req) {
  try {
    ...
    if (!adminPassword) {
      return new Response(
        JSON.stringify({ message: "Admin password is required." }),
        {
          status: 400,
          headers: { "Content-Type": "application/json" },
        }
    ...
    return new Response(
      JSON.stringify({ 
        message: `Seeding completed! Created ${createdCount} challenges, skipped ${skippedCount} existing challenges.`,
    ...
    return new Response(
      JSON.stringify({ message: "Server error during seeding" }),
      {
        status: 500,
        headers: { "Content-Type": "application/json" },
      }
